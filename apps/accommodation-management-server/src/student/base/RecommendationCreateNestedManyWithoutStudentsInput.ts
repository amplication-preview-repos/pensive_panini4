...
@InputType()
class RecommendationCreateNestedManyWithoutStudentsInput {
...
export { RecommendationCreateNestedManyWithoutStudentsInput as RecommendationCreateNestedManyWithoutStudentsInput };
